                ...
                <tbody>
                  ...
                  {rows.length === 0 ? (
                    ...
                    <tr key={r.date} className="border-t border-slate-100 hover:bg-slate-50/70" data-testid={`ledger-row-${r.date}`}>
                      <td className="p-2.5 whitespace-nowrap text-slate-700">{formatDate(r.date)}</td>
                      ...
                      <td className={`p-2.5 text-right tabular-nums font-semibold border-l border-slate-50 ${r.adj_qty > 0 ? "text-emerald-700" : r.adj_qty < 0 ? "text-rose-700" : "text-slate-400"}`} title="Stock-take adjustment (physical count vs system)">
